...
async function saveEditName(){
    ...
    if(new_name !== old_name){
        const res = await fetch(`http://tooguildtogo.onrender.com/customers/${current_id}`, {
            method: 'PATCH',
...
async function deleteAccount() {
    ...
    try {
        const res = await fetch("http://tooguildtogo.onrender.com/customers/delete-account", {
            method: "POST",
            headers: {
